(function (f) {
  ...
  return (function () {
  ...
  })()(
    {
      "/js/index.js": [
        ...
        { "./imgManager": 2, "./templates": 3, "docxtemplater": 5, "xmldom": 25 },
      ],
      1: [
        function (require, module, exports) {
          "use strict";
  ...
  */
              ...
              _createClass(Docxtemplater, [
                ...
                },
                {
                  ...
                  value: function resolveData(data) {
                    ...
                    return Promise.all(
                      Object.keys(this.compiled).map(function (from) {
        ...
        function (require, module, exports) {
          ...
          function Reader(innerContentParts) {
            ...
            this.parseDelimiters = function (delimiters) {
              _this.full = _this.innerContentParts
                .map(function (p) {
                  return p.value;
                })
                .join("");
      ...
      11: [
        ...
        { "../doc-utils": 4, "../errors": 6, "../mergesort": 9, "../module-wrapper": 10, "../traits": 22 },
      ],
      12: [
        function (require, module, exports) {
          "use strict";
        ...
        { "../doc-utils": 4, "../module-wrapper": 10, "../prefix-matcher": 18 },
      ],
      13: [
        function (require, module, exports) {
          "use strict";
        ...
        { "../doc-utils": 4, "../errors": 6, "../module-wrapper": 10, "../prefix-matcher": 18, "../traits": 22 },
      ],
      14: [
        function (require, module, exports) {
          "use strict";
                          ...
                          value: lines
                            ...
                            .join(
                              "</"
                                ...
                                .concat(runprops, "<")
                                .concat(p, ":t")
                                .concat(this.fileType === "docx" ? ' xml:space="preserve"' : "", ">")
                            ),
                        };
                      }
        ...
        { "../doc-utils": 4, "../errors": 6, "../module-wrapper": 10 },
      ],
      15: [
        function (require, module, exports) {
          "use strict";
